    ...
    <div class="container  text-center  texto">
        <form id="form1" runat="server">
            <div>
                ...
                <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="RangeValidator" Display="Dynamic" ForeColor="#CC0000" Text="Debe introducir un año entre 1970 y 2017" ClientIDMode="Inherit" MaximumValue="2017" MinimumValue="1970" ControlToValidate="TextBox1_1" Type="Integer"></asp:RangeValidator>
                ...
                <asp:RangeValidator ID="RangeValidator2" runat="server" ErrorMessage="RangeValidator" Display="Dynamic" ForeColor="#CC0000" Text="Debe introducir una cantiada entre 1 y 100" ClientIDMode="Inherit" MaximumValue="100" MinimumValue="1" ControlToValidate="TextBox1_2" Type="Integer"></asp:RangeValidator>
