    ...
    <div class="container  text-center  texto">
        <form id="form1" runat="server">
            ...
            <p>
                ...
                <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="RangeValidator" Display="Dynamic" ForeColor="#CC0000" Text="Debe introducir un año entre 1970 y 2017" ClientIDMode="Inherit" MaximumValue="2017" MinimumValue="1970" ControlToValidate="cambioAnio"></asp:RangeValidator>
            ...
            <p>
                ...
                <asp:RangeValidator ID="RangeValidator2" runat="server" ErrorMessage="RangeValidator" Text="Debe introducir una cantidad entre 0 y 100" ForeColor="#CC0000" Display="Dynamic" MaximumValue="100" MinimumValue="0" ControlToValidate="cambiarCantidad"></asp:RangeValidator>
