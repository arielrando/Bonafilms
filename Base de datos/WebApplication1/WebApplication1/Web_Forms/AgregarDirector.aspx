    ...
    <div class="container  text-center  texto">
        <form id="form1" runat="server">
            <div>
                ...
                Apellido:
                <asp:TextBox ID="nuevoDirector1" runat="server"></asp:TextBox>

                <!-- El apellido del director debe ser obligatorio y debe contener únicamente letras !-->

                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="nuevoDirector1" Display="Dynamic" ForeColor="#CC0000">Debe introducir un apellido</asp:RequiredFieldValidator>

                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="RegularExpressionValidator" ControlToValidate="nuevoDirector1" ForeColor="#CC0000" ValidationExpression="^[A-Z a-z]*$" Display="Dynamic">El campo debe contener solo letras</asp:RegularExpressionValidator>
